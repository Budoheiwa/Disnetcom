...
keyword_group = create_keygroups("users.txt")

# Now call copy_lines with the obtained keyword_group
input_file_name = 'D:/dossier/Cours/INGE3/projet/ftp_rawdata.txt'
output_file_name = 'D:/dossier/Cours/INGE3/projet/mdp.txt'
